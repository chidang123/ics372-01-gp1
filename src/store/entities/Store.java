...
public class Store implements Serializable {
	 ...
	 * 
	 * @param productID
	 * @returns the Order with the passed productID
	 */
	...
	/**
	 * @param productID
	 * @returns the Product with the passed productID if it's found
	 */
	 ...
	 * @param address
	 * @param phoneNumber
	 * @param feePaid     creates a new member using the passed arguments and
	...
	/**
	 * removes the member with the passed memberID using the appropriate method
	 * from memberList if the member exists
	 * 
	 * @param memberID
	 * @returns boolean
	 */
	 ...
	 * @returns a newly created product with the passed parameters
	 */
	...
	/**
	 * updates products in productList with new inventory count after checkout,
	 * creates transaction and adds it to the member's transaction list, and
	 * creates a new order if necessary
	 * 
	 * @param memberID
	 * @param productIds
	 * @param productQtys
	...
	/**
	 * finds a product in the product list and changes its price
	 * 
	 * @param productID
	 * @param newPrice
	 */
	...
	/**
	 * @param productString
	 * @returns a String that lists products that have names which begin with
	 *          the passed string
	 */
	...
	/**
	 * returns a String that lists all the transactions of a specific member
	 * which occurred between the dates given as arguments
	 * 
	 * @param memberID
	 * @param startDate
	 * @param endDate
	...
	/**
	 * @returns a String that lists all products in productList along with some
	 *          of their attributes
	 */
	...
	/**
	 * @returns saved StoreData if it exists
	 */
